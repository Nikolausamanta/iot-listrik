              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="nama_schedule" value="{{$edit_schedule->nama_schedule}}" placeholder="Schedule Name" aria-label="Name" aria-describedby="name-addon">
